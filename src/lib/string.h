...
/*
 * memmove does not allocate extra memory and handles
...
/*
 * For string functions, please specify `n` explicitly.
 * strncpy will fill `dest` with zeroes if the length of `src` is less than `n`.
