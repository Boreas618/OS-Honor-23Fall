...
static WARN_RESULT ALWAYS_INLINE int 
cpuid() 
{
    u64 id;
...
static WARN_RESULT ALWAYS_INLINE u64 
get_clock_frequency() 
{
    u64 result;
 ...
 */
static ALWAYS_INLINE void 
device_put_u32(u64 addr, u32 value) 
{
    compiler_fence();
...
static WARN_RESULT ALWAYS_INLINE u32 
device_get_u32(u64 addr) 
{
    compiler_fence();
...
static inline WARN_RESULT bool 
_arch_enable_trap() 
{
    u64 t;
...
static ALWAYS_INLINE NO_RETURN void 
arch_stop_cpu() 
{
    while (1)
        arch_wfe();
